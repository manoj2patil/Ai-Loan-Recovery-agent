...
export function defaultRules(): BusinessRule[] {
  ...
  return [
    ...
    mk({ id: "BR03", name: "Overdue notice", bucket: "31-60", action: "WHATSAPP",
         triggerDpd: 31, template: "overdue_notice", rbiRef: "RBI IRAC Master Circular (SMA-1 follow-up)" }),
    ...
    mk({ id: "BR05", name: "PTP reminder", bucket: "31-60", action: "WHATSAPP",
         triggerDpd: 45, template: "ptp_reminder", rbiRef: "Internal policy — promise follow-up" }),
    ...
    mk({ id: "BR09", name: "NPA classification notice", bucket: "91-180", action: "WHATSAPP",
         triggerDpd: npa, template: "npa_classification_notice", rbiRef: "RBI IRAC — NPA at 90 DPD" }),
